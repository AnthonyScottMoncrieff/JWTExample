...
namespace JWTExample.Domain.Helpers
{
    ...
    {
        public async Task<Account> getAccount(int id, DataContext dataContext)
        {
        ...
        public async Task<(RefreshToken, Account)> getRefreshToken(string token, DataContext dataContext)
        {
